...
ARCH=x86_64
COMPILER=gcc
INSTALL_PREFIX=${HOME}/data/bin/${ARCH}/gromacs/${VERSION}/gpu/${COMPILER}
...
module purge
module load gcc/10.3.0 cuda/11.6.2 cmake/3.21.1
...
module purge
module load gcc/10.3.0 cuda/11.6.2 openmpi_cuda/4.1.2 cmake/3.21.1
