...
ARCH=x86_64
COMPILER=intel
INSTALL_PREFIX=/home/z43901k/data/bin/${ARCH}/gromacs/${VERSION}/cpu/${COMPILER}
...
module purge
module load gcc/10.3.0 cmake/3.17.3
. /home/center/opt/x86_64/cores/intel/compilers_and_libraries_2018.5.274/linux/bin/compilervars.sh intel64
...
mkdir build_${ARCH}_sp_nompi_${COMPILER}
cd build_${ARCH}_sp_nompi_${COMPILER}
cmake .. \
...
mkdir build_${ARCH}_dp_nompi_${COMPILER}
cd build_${ARCH}_dp_nompi_${COMPILER}
cmake .. \
   -DCMAKE_INSTALL_PREFIX=${INSTALL_PREFIX} \
   -DCMAKE_VERBOSE_MAKEFILE=ON \
   -DGMX_MPI=OFF \
...
mkdir build_${ARCH}_sp_mpi_${COMPILER}
cd build_${ARCH}_sp_mpi_${COMPILER}
cmake .. \
   -DCMAKE_INSTALL_PREFIX=${INSTALL_PREFIX} \
   -DCMAKE_VERBOSE_MAKEFILE=ON \
   -DGMX_MPI=ON \
...
mkdir build_${ARCH}_dp_mpi_${COMPILER}
cd build_${ARCH}_dp_mpi_${COMPILER}
cmake .. \
   -DCMAKE_INSTALL_PREFIX=${INSTALL_PREFIX} \
   -DCMAKE_VERBOSE_MAKEFILE=ON \
   -DGMX_MPI=ON \
